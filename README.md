...
Installing quic-n-dirty requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
## Exploring quic-n-dirty

After building quic-n-dirty, you can explore its exports at the Node REPL:
